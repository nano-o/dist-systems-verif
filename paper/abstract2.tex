\abstract{
  ...
  processors become more unreliable but more numerous.
    ...
    of the art optimization and reconfiguration techniques built-in:
    primary-backup replication, tolerating k fault with k+1
    ...
    \begin{itemize}
      \item Checkpointing
      \item Primary-backup replication with expeditive reads, k-fault tolerance with
        k+1 replicas.
      \item Latency of two messages when contention happens only on commutative
        commands.
    \end{itemize}
