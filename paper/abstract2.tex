\abstract{
  ...
  processors become more unreliable but more numerous.
    ...
    The key novelty of our framework is its practial applicability, having state
    of the art optimization techniques built-in: it supports executing commutative commands 
    without synchronization, optimizing the execution of read-only commands,
    minimizing the size of crucial data structures. 

    We present a detailed, mechanically-proved formalization of our framework
    and we show how several SMR algorithms fit into our framework.
    We classify SMR algorithms in two categories corresponding to two abstract
    specifications that the algorithms refine.
