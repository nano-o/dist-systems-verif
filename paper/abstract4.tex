...
State-Machine Replication (SMR) algorithms are notoriously hard to understand
and devising new and more performant SMR algorithms is costly. To lower this
cost, we present a framework for building SMR algorithms out of independent
and reusable modules. A module is an SMR algorithm that can abort and pass
the baton to another module, allowing to dynamically switch between modules.
Our composition theorem ensures that the composition of any number of modules
satisfying Composable Generalized Consensus (CGC), our correctness condition for
modules, is a correct SMR algorithm.
...
rounds, each providing a template to devise new modules with the help of the
