...
To lower the cost of designing new SMR algorithms, we present a framework for composing independent and reusable SMR modules. 
An SMR module is an SMR algorithm augmented with a composition interface. 
...
Our composition theorem guarantees that the result of composing two SMR modules is again an SMR module and a correct SMR algorithm.
...
To help design new modules in practice, we propose several TLA$^+$ specifications that each
