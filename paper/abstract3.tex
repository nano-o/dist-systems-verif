...
We present a framework that enables building SMR algorithms out of independent modules. A module is an SMR algorithm that can abort its execution and pass the baton to a new module, allowing to build composite SMR algorithms which can dynamically switch between modules. 
