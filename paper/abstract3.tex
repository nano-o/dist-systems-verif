...
To demonstrate our framework we present two abstract composable algorithms
characterizing two popular types of quorum systems. We demonstrate that concrete
algorithms can easily be obtained by refinement from the abstract algorithms, as
