...
Thanks to the inter-round interface, Simple-Leader rounds and Broadcast-Decide rounds can be composed in any order.
To compose a Simple-Leader round $SL_1$ with an Broadcast-Decide round $B_2$, we compose their specifications as before, adding the constraint that the set $aborts_1$ be equal to the set $inits_2$ at all times.
